/**
 * Lightweight WebSocket signaling server for local tests.
 * Run: npm install && npm run start-signaling
 * Use ngrok (ngrok http 3001) to expose it as wss:// for GitHub Pages.
 */
