...
import ru.chousik.backend_calls.config.TelegramProperties;
...
public class TelegramAuthService {
    ...
    public TelegramAuthService(TelegramProperties telegramProperties,
    ...
    private String signData(String data) {
        try {
            ...
            SecretKeySpec secretKeySpec = new SecretKeySpec(
                    telegramProperties.secretKey().getBytes(StandardCharsets.UTF_8),
                    HMAC_ALGORITHM
            );
